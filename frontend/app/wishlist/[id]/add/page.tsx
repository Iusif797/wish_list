        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-slate-200 p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">Auto-fill name, image and price from URL</p>
            </div>
            <div>
            ...
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1">Target amount (₽) — for group gift</label>
              <input
                type="number"
                value={targetAmount}
