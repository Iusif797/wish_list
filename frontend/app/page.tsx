  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center animate-fade-in">
        ...
        <p className="text-slate-600 text-center max-w-lg mb-10 text-lg leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <Link
            href="/register"
            className="px-8 py-3.5 glass-card text-slate-700 font-semibold rounded-2xl hover:bg-white transition-all text-center"
          >
            Create account
          </Link>
        </div>
